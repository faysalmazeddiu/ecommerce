...
<h2 class="heading-title"><span>Latest Products</span></h2>
          ...
          {
          ?>
                <div class="prod_hold"> <a class="wrap_link" href="{{URL::to('/product-details/'.$v_product->id)}}"> <span class="image"><img src="{{asset($v_product->product_image)}}" width='180' height="180" alt="Spicylicious store" /></span> </a>
